...
- **株価予測機能**: 機械学習による株価予測 ✅
- **自動売買機能**: Mark1エージェントによる継続監視・自動売買 ✅
- **リスク管理機能**: 損切り・利確、資金管理 ✅
- **デモトレード機能**: 仮想資金での取引練習 ✅
...
2. **kabuステーションAPI**: 三菱UFJ eスマート証券の公式API利用 ✅
...
- [フェーズ1: 基盤構築](./docs/phases/phase1-foundation.md)
- [フェーズ2: データ取得・表示機能](./docs/phases/phase2-data-acquisition.md)
- [フェーズ3: 予測機能開発](./docs/phases/phase3-prediction-features.md)
- [プロジェクトサマリー](./docs/phases/phase-summary.md)

### 技術調査

- [株価API調査](./docs/research/stock-api-research.md)
...
│   ├── agents/           # 自動売買エージェント
│   │   ├── mark1-agent.ts
│   │   └── mark1-enhanced-agent.ts
│   ├── app/              # Next.js App Router
│   │   ├── api/          # API Routes
│   │   └── page.tsx      # メインページ
│   ├── components/       # React コンポーネント
│   ├── core/             # コア機能（認証、DB、Redis）
...
6. **Mark1自動売買エージェント**: 継続監視・自動売買・リスク管理
7. **デモトレード**: 仮想資金での取引練習・レポート生成
